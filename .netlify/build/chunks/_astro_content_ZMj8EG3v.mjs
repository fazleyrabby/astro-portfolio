...
import { A as AstroError, R as RenderUndefinedEntryError, c as createComponent, u as unescapeHTML, r as renderTemplate, U as UnknownContentCollectionError, f as renderUniqueStylesheet, g as renderScriptElement, h as createHeadAndContent, a as renderComponent } from './astro/server_CqgkFk_a.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_k7kR1Fbm.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DgiDkRiI.mjs').then(n => n._);
