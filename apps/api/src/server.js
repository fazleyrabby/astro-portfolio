...
async function translateAIContent(content, targetLang) {
    ...
    const prompt = `You are a professional translator. Translate the following Markdown content into ${targetLang}. 
Tone: Professional yet simple, and very user-friendly. Do NOT use overly complicated words.
REQUIREMENTS: 
