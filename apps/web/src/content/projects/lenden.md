...
solution: "Payment gateway abstraction platform built with Laravel — merchants configure gateways via UI, not code."
...
tech: ["PHP", "Laravel 8", "JavaScript", "Payment Integration"]
position: 6
---
